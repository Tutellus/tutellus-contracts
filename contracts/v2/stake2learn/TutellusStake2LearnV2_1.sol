...
contract TutellusStake2LearnV2_1 is OwnableUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;

    address public constant NEW_TOKEN = 0x06737D16aD9C1E41aA44FEe2a952B26723B20673;
    address public constant TREASURY = 0x07B411B9e6ACA64B4e4b44B36c5188d0F5F8250E;
    ...
    function withdraw() public onlyOwner {
        ...
        if (oldBalance > 0) {
            _token.safeTransfer(TREASURY, oldBalance);
            IERC20Upgradeable(NEW_TOKEN).safeTransferFrom(TREASURY, address(this), oldBalance);
        }
